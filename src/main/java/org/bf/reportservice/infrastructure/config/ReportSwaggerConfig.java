package org.bf.reportservice.infrastructure.config;
...
public class ReportSwaggerConfig {
    ...
    private final String PREFIX = "/v1/report";
    ...
    public OpenAPI openAPI(@Value("${openapi.service.url}") String url) {
        return new OpenAPI()
                ...
                .info(new Info().title("Barrier-Free-Friends Report Service").version("1.0")
